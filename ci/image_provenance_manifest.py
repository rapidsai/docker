...
class ManifestContext:
    """Stable identity and build inputs for a provenance manifest."""
...
def parse_platform_manifest(value: str) -> dict[str, str]:
    ...
    _os_name, separator3, _architecture = platform.partition("/")
...
def build_manifest(
    ...
    *,
    ...
    if not context.image_digest.startswith("sha256:"):
    ...
    if context.platform != "multiarch":
        os_name, separator, architecture = context.platform.partition("/")
        if not separator:
    ...
    manifest: dict[str, Any] = {
        ...
        "subject": subject,
        "image": {
            "kind": context.image_kind,
            "rapids_version": context.rapids_version,
        ...
        "build": {
            ...
            "build_args": parse_build_args(context.build_args),
        },
