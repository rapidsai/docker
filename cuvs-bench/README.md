...
docker run --gpus all --rm -it \
    ...
    -u $(id -u) \
    rapidsai/cuvs-bench:26.06a-cuda13-py3.14 \
...
- `rapidsai/cuvs-bench:26.06a-cuda13-py3.14`: Image to use, `cuvs-bench`, cuVS version, CUDA version, and Python version.
...
docker run  all --rm -it \
    -v $DATA_FOLDER:/home/rapids/benchmarks \
    -u $(id -u) \
    rapidsai/cuvs-bench-cpu:26.06a-py3.14 \
     "--dataset deep-image-96-angular" \
     "--normalize" \
     "--algorithms cuvs_cagra" \
     ""
