...
docker run --gpus all --rm -it \
    ...
    -u $(id -u) \
    rapidsai/cuvs-bench:26.02a-cuda13-py3.13 \
...
- `rapidsai/cuvs-bench:26.02a-cuda13-py3.13`: Image to use, either `cuvs-bench` or `cuvs-bench-datasets`, cuVS version, CUDA version, and Python version.
...
docker run  all --rm -it \
    -v $DATA_FOLDER:/home/rapids/benchmarks \
    -u $(id -u) \
    rapidsai/cuvs-bench-cpu:26.02a-py3.13 \
     "--dataset deep-image-96-angular" \
     "--normalize" \
     "--algorithms cuvs_cagra" \
     ""
