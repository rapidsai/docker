...
docker run --gpus all --rm -it \
    ...
    -u $(id -u) \
    rapidsai/cuvs-bench:25.08a-cuda12.8-py3.13 \
...
- `rapidsai/cuvs-bench:25.08a-cuda12.8-py3.13`: Image to use, either `cuvs-bench` or `cuvs-bench-datasets`, cuVS version, CUDA version, and Python version.
