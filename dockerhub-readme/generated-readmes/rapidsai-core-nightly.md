...
### RAPIDS NIGHTLY v23.08a

Versions of libraries included in the `23.08` images:
- `cuDF` [v23.08.00a](https://github.com/rapidsai/cudf), `cuML` [v23.08.00a](https://github.com/rapidsai/cuml), `cuGraph` [v23.08.00a](https://github.com/rapidsai/cugraph), `RMM` [v23.08.00a](https://github.com/rapidsai/RMM), `RAFT` [v23.08.00a](https://github.com/rapidsai/raft), `cuSpatial` [v23.08.00a](https://github.com/rapidsai/cuspatial), `cuSignal` [v23.08.00a](https://github.com/rapidsai/cusignal), `cuxfilter` [v23.08.00a](https://github.com/rapidsai/cuxfilter)
...
```
23.08-cuda11.8-runtime-ubuntu22.04-py3.10
 ^       ^    ^        ^         ^
 |       |    type     |         python version
 |       |             |
 |       cuda version  |
...
```bash
$ docker pull rapidsai/rapidsai-core-nightly:23.08-cuda11.8-runtime-ubuntu22.04-py3.10
...
Notebooks can be found in the following directories within the 23.08 container (not applicable for `base` images):
...
For a full description of each notebook, see the [README](https://github.com/rapidsai/notebooks/blob/branch-23.08/README.md) in the notebooks repository.
