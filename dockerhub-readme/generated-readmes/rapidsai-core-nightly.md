...
### RAPIDS NIGHTLY v21.06a

Versions of libraries included in the `21.06` images:
- `cuDF` [v21.06.0a](https://github.com/rapidsai/cudf), `cuML` [v21.06.0a](https://github.com/rapidsai/cuml), `cuGraph` [v21.06.0a](https://github.com/rapidsai/cugraph), `RMM` [v21.06.0a](https://github.com/rapidsai/RMM), `cuSpatial` [v21.06.0a](https://github.com/rapidsai/cuspatial), `cuSignal` [v21.06.0a](https://github.com/rapidsai/cusignal), `cuxfilter` [v21.06.0a](https://github.com/rapidsai/cuxfilter)
...
```bash
$ docker pull rapidsai/rapidsai-core-nightly:21.06-cuda11.0-runtime-ubuntu18.04-py3.7
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         rapidsai/rapidsai-core-nightly:21.06-cuda11.0-runtime-ubuntu18.04-py3.7
```
