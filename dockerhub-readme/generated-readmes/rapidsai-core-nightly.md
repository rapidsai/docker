...
**IMPORTANT:** For our latest stable release please use the [rapidsai/rapidsai-core](https://hub.docker.com/r/rapidsai/rapidsai-core) containers.
...
### RAPIDS NIGHTLY v23.02a

Versions of libraries included in the `23.02` images:
- `cuDF` [v23.02.00a](https://github.com/rapidsai/cudf), `cuML` [v23.02.00a](https://github.com/rapidsai/cuml), `cuGraph` [v23.02.00a](https://github.com/rapidsai/cugraph), `RMM` [v23.02.00a](https://github.com/rapidsai/RMM), `RAFT` [v23.02.00a](https://github.com/rapidsai/raft), `cuSpatial` [v23.02.00a](https://github.com/rapidsai/cuspatial), `cuSignal` [v23.02.00a](https://github.com/rapidsai/cusignal), `cuxfilter` [v23.02.00a](https://github.com/rapidsai/cuxfilter)
...
This repo (rapidsai-core-nightly), contains the following:
...
The [rapidsai/rapidsai-core-dev-nightly](https://hub.docker.com/r/rapidsai/rapidsai-core-dev-nightly/tags) repo contains the following:
...
```
23.02-cuda11.5-runtime-ubuntu18.04-py3.9
 ^       ^    ^        ^         ^
 |       |    type     |         python version
 |       |             |
 |       cuda version  |
...
```
cuda11.5-runtime-ubuntu18.04-py3.9
```
...
```bash
$ docker pull rapidsai/rapidsai-core-nightly:23.02-cuda11.5-runtime-ubuntu18.04-py3.9
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         rapidsai/rapidsai-core-nightly:23.02-cuda11.5-runtime-ubuntu18.04-py3.9
```
...
Notebooks can be found in the following directories within the 23.02 container (not applicable for `base` images):
