...
- `blazingsql` [v21.06](https://github.com/BlazingDB/blazingsql), `xgboost` [branch](https://github.com/rapidsai/xgboost), `dask-cuda` [branch](https://github.com/rapidsai/dask-cuda)
...
```bash
$ docker pull rapidsai/rapidsai-nightly:21.06-cuda11.0-runtime-ubuntu18.04-py3.7
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         rapidsai/rapidsai-nightly:21.06-cuda11.0-runtime-ubuntu18.04-py3.7
```
