...
```bash
$ docker pull nvcr.io/nvidia/rapidsai/rapidsai-core-dev:22.06-cuda11.0-devel-ubuntu18.04-py3.8
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         nvcr.io/nvidia/rapidsai/rapidsai-core-dev:22.06-cuda11.0-devel-ubuntu18.04-py3.8
```
