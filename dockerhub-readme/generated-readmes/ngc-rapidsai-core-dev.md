...
- `cuDF` [v23.06](https://github.com/rapidsai/cudf/tree/v23.06.00), `cuML` [v23.06](https://github.com/rapidsai/cuml/tree/v23.06.00), `cuGraph` [v23.06](https://github.com/rapidsai/cugraph/tree/v23.06.00), `RMM` [v23.06](https://github.com/rapidsai/RMM/tree/v23.06.00), `RAFT` [v23.06](https://github.com/rapidsai/raft/tree/v23.06.00), `cuSpatial` [v23.06](https://github.com/rapidsai/cuspatial/tree/v23.06.00), `cuSignal` [v23.06](https://github.com/rapidsai/cusignal/tree/v23.06.00), `cuxfilter` [v23.06](https://github.com/rapidsai/cuxfilter/tree/v23.06.00)
...
```bash
$ docker pull nvcr.io/nvidia/rapidsai/rapidsai-core-dev:23.06-cuda11.8-devel-ubuntu22.04-py3.10
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         nvcr.io/nvidia/rapidsai/rapidsai-core-dev:23.06-cuda11.8-devel-ubuntu22.04-py3.10
```
