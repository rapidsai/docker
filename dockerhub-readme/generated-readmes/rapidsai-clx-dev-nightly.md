...
```bash
$ docker pull rapidsai/rapidsai-clx-dev-nightly:21.12-cuda11.0-devel-ubuntu18.04-py3.7
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         rapidsai/rapidsai-clx-dev-nightly:21.12-cuda11.0-devel-ubuntu18.04-py3.7
```
