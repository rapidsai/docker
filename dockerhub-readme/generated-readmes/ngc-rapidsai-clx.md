...
- `cuDF` [v22.10](https://github.com/rapidsai/cudf/tree/v22.10.00), `cuML` [v22.10](https://github.com/rapidsai/cuml/tree/v22.10.00), `cuGraph` [v22.10](https://github.com/rapidsai/cugraph/tree/v22.10.00), `RMM` [v22.10](https://github.com/rapidsai/RMM/tree/v22.10.00), `RAFT` [v22.10](https://github.com/rapidsai/raft/tree/v22.10.00), `cuSpatial` [v22.10](https://github.com/rapidsai/cuspatial/tree/v22.10.00), `cuSignal` [v22.10](https://github.com/rapidsai/cusignal/tree/v22.10.00), `cuxfilter` [v22.10](https://github.com/rapidsai/cuxfilter/tree/v22.10.00), `clx` [v22.10](https://github.com/rapidsai/clx/tree/v22.10.00)
...
```
22.10-cuda11.5-runtime-ubuntu18.04-py3.9
 ^       ^    ^        ^         ^
 |       |    type     |         python version
 |       |             |
 |       cuda version  |
...
```bash
$ docker pull nvcr.io/nvidia/rapidsai/rapidsai-clx:22.10-cuda11.5-runtime-ubuntu18.04-py3.9
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         nvcr.io/nvidia/rapidsai/rapidsai-clx:22.10-cuda11.5-runtime-ubuntu18.04-py3.9
```
...
Notebooks can be found in the following directories within the 22.10 container (not applicable for `base` images):
