...
### Current Version - RAPIDS v22.08

Versions of libraries included in the `22.08` images:
- `cuDF` [v22.08](https://github.com/rapidsai/cudf/tree/v22.08.00), `cuML` [v22.08](https://github.com/rapidsai/cuml/tree/v22.08.00), `cuGraph` [v22.08](https://github.com/rapidsai/cugraph/tree/v22.08.00), `RMM` [v22.08](https://github.com/rapidsai/RMM/tree/v22.08.00), `RAFT` [v22.08](https://github.com/rapidsai/raft/tree/v22.08.00), `cuSpatial` [v22.08](https://github.com/rapidsai/cuspatial/tree/v22.08.00), `cuSignal` [v22.08](https://github.com/rapidsai/cusignal/tree/v22.08.00), `cuxfilter` [v22.08](https://github.com/rapidsai/cuxfilter/tree/v22.08.00), `clx` [v22.08](https://github.com/rapidsai/clx/tree/v22.08.00)
...
The [rapidsai/rapidsai-clx-dev](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/rapidsai/containers/rapidsai-clx-dev/tags) repo contains the following:
...
```
22.08-cuda11.5-runtime-ubuntu18.04-py3.9
 ^       ^    ^        ^         ^
 |       |    type     |         python version
 |       |             |
 |       cuda version  |
...
To get the latest RAPIDS version of a specific platform combination, simply exclude the RAPIDS version. For example, to pull the latest version of RAPIDS for the `runtime` image with support for CUDA 11.5, Python 3.9, and Ubuntu 18.04, use the following tag:
```
cuda11.5-runtime-ubuntu18.04
```

Many users do not need a specific platform combination but would like to ensure they're getting the latest version of RAPIDS, so as an additional convenience, a tag named simply `latest` is also provided which is equivalent to `cuda11.5-runtime-ubuntu18.04-py3.9`.
...
```bash
$ docker pull nvcr.io/nvidia/rapidsai/rapidsai-clx:22.08-cuda11.5-runtime-ubuntu18.04-py3.9
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         nvcr.io/nvidia/rapidsai/rapidsai-clx:22.08-cuda11.5-runtime-ubuntu18.04-py3.9
```
...
Notebooks can be found in the following directories within the 22.08 container (not applicable for `base` images):
...
For a full description of each notebook, see the [README](https://github.com/rapidsai/notebooks/blob/branch-22.08/README.md) in the notebooks repository.
