...
- `cuDF` [v23.02.00a](https://github.com/rapidsai/cudf), `cuML` [v23.02.00a](https://github.com/rapidsai/cuml), `cuGraph` [v23.02.00a](https://github.com/rapidsai/cugraph), `RMM` [v23.02.00a](https://github.com/rapidsai/RMM), `RAFT` [v23.02.00a](https://github.com/rapidsai/raft), `cuSpatial` [v23.02.00a](https://github.com/rapidsai/cuspatial), `cuSignal` [v23.02.00a](https://github.com/rapidsai/cusignal), `cuxfilter` [v23.02.00a](https://github.com/rapidsai/cuxfilter), `clx` [v23.02](https://github.com/rapidsai/clx)
...
```bash
$ docker pull rapidsai/rapidsai-clx-nightly:23.02-cuda11.5-runtime-ubuntu18.04-py3.9
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         rapidsai/rapidsai-clx-nightly:23.02-cuda11.5-runtime-ubuntu18.04-py3.9
```
