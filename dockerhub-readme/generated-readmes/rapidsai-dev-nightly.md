...
- `dask-sql` [2023.6.0](https://github.com/dask-contrib/dask-sql), `xgboost` [branch](https://github.com/rapidsai/xgboost), `dask-cuda` [branch](https://github.com/rapidsai/dask-cuda)
...
This repo (rapidsai/rapidsai-dev-nightly), contains the following:
...
```
23.08-cuda11.8-devel-ubuntu22.04-py3.10
 ^       ^    ^        ^         ^
 |       |    type     |         python version
 |       |             |
 |       cuda version  |
...
```bash
$ docker pull rapidsai/rapidsai-dev-nightly:23.08-cuda11.8-devel-ubuntu22.04-py3.10
$ docker run --gpus all --rm -it -p 8888:8888 -p 8787:8787 -p 8786:8786 \
         rapidsai/rapidsai-dev-nightly:23.08-cuda11.8-devel-ubuntu22.04-py3.10
```
...
Notebooks can be found in the following directories within the 23.08 container :
