...
COMMANDSUTILS_DIR=${RAPIDSDEVTOOL_DIR}/commands/utils
...
REPOSETTINGS_FILE_NAME=${RAPIDSDEVTOOL_DIR}/repoSettings
DOCKERARGS_FILE_NAME=${RAPIDSDEVTOOL_DIR}/dockerArgs
