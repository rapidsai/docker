...
**Note: Nightly builds of the images have the RAPIDS version appended with an `a` (ie `25.02a-cuda12.8-py3.12`)**
...
$ docker run \
    ...
    -p 8888:8888 \
    rapidsai/notebooks:25.02-cuda12.8-py3.12
```
