...
**Note: Nightly builds of the images have the RAPIDS version appended with an `a` (ie `26.10a-cuda13-py3.14`)**
...
$ docker run \
    ...
    -p 8888:8888 \
    rapidsai/notebooks:26.10-cuda13-py3.14
```
...
$ docker run \
    ...
    rapidsai/base:26.10-cuda13-py3.14
```
