...
The RAPIDS images are based on [`nvidia/cuda`](https://hub.docker.com/r/nvidia/cuda).
The RAPIDS images provide `amd64` & `arm64` architectures [where supported](https://docs.rapids.ai/install#system-req).
...
**Note: Nightly builds of the images have the RAPIDS version appended with an `a` (ie `26.02a-cuda13-py3.13`)**
...
$ docker run \
    ...
    -p 8888:8888 \
    rapidsai/notebooks:26.02-cuda13-py3.13
```
...
$ docker run \
    ...
    rapidsai/base:26.02-cuda13-py3.13
```
