...
**Note: Nightly builds of the images have the RAPIDS version appended with an `a` (ie `25.08a-cuda12.8-py3.13`)**
...
$ docker run \
    ...
    -p 8888:8888 \
    rapidsai/notebooks:25.08-cuda12.8-py3.13
```
...
$ docker run \
    ...
    rapidsai/base:25.08-cuda12.8-py3.13
```
